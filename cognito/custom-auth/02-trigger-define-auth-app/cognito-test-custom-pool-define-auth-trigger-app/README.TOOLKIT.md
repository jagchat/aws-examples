...
* cognito-test-custom-pool-define-auth-trigger-app:HelloWorldFunction (nodejs14.x)
* API cognito-test-custom-pool-define-auth-trigger-app:HelloWorldFunction (nodejs14.x)
